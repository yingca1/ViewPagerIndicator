 ...
 */
public class CirclePagerIndicator extends View implements BasicViewPagerIndicator {
    ...
    private void init() {
        ...
        final int defaultPageColor = Color.parseColor("#e9e9e9");
        final int defaultFillColor = Color.parseColor("#9b9b9b");
        final int defaultOrientation = HORIZONTAL;
        final int defaultStrokeColor = Color.parseColor("#e9e9e9");
        final float defaultStrokeWidth = Utils.dp2px(getContext(), 1);
        final float defaultRadius = Utils.dp2px(getContext(), 2);
